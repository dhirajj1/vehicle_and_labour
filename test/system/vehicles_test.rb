...
class VehiclesTest < ApplicationSystemTestCase
  ...
  test "should create vehicle" do
    ...
    fill_in "Destination address", with: @vehicle.destination_address
    fill_in "Destination time", with: @vehicle.destination_time
    fill_in "Name", with: @vehicle.name
    fill_in "Pick up address", with: @vehicle.pick_up_address
    fill_in "Pick up time", with: @vehicle.pick_up_time
    fill_in "Vehicle", with: @vehicle.vehicle
